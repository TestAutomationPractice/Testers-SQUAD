...
public class AdminLoginTest extends TestBase {
	...
	public void verifyUsergetsLoggedIn() throws IOException, InterruptedException {
		...
		loginPage.verifyAdminUserLogin();
	}
	...
	@Test(description = "Verify admin add movie functionality", dependsOnMethods = { "verifyAddMovieInvalidMessage" })
	public void verifyAddMovieFunctionality() throws IOException, InterruptedException {
		AddMoviePage moviePage = new AddMoviePage();
		moviePage.verifyAdminAddMovie();
	}
